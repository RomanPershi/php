            ...
            <form class="buttons" action="auth.php" method="POST">
                <div class="buttons">
                    <div class="inputgrid">
                        ...
                        <div class="nameorsub">
                            <input type="password" class="yourname" name="pass" id="pass" placeholder="Your Password"
                                   autocomplete="off">
                        </div>
                    </div>
                    <div class="biginput">
...
<?php else:
    ...
    <div class="container">
        ...
        <div class="mainmenu">
            <form class="buttons" action="exit.php" method="POST">
                <button style="margin-bottom:20px;" id="back" type="submit" class="button6" name="button">< Выйти
                </button>
            </form>
            <form class="buttons" action="admin.php" method="GET">
                <div class="buttons">
            ...
            if ($mode == 1):?>
                ...
                <div class="addm">
                    <form class="" action="orders.php" method="post">
                        <button type="submit" class="btn-new2" name="button">История заказов</button>
                    </form>
                </div>
            <?php else:  ?>
                <div class="addm">
                    <form class="" action="release.php" method="post">
        ...
        <div class="maininfo">
           ...
           $query = $query . ' LIMIT '.$offset.', '.$size_page;
            ...
            foreach ($result as $row) {
                $is_visible = $row['count'] == 0 ? 'none' : 'block';
          ...
          ";
             ...
             <div style='margin-right:10px;' class='buttons'>
                    ...
                    if (compareid($order_query,$row['id']))
                    {
                        $name_button = "Убрать";
                    }
                    $vari = $vari."<div style='display: flex;margin-top: 10px;'>
              <button type='button' style='display: ".$is_visible."' name='add_product' value='" . $row['id'] . "' class='button6'>".$name_button."</button>
             </div>";
                }
                $vari = $vari." </div>
            </div>
